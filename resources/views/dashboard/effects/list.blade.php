                    ...
                    <tbody>
                        @foreach($effects as $effect)
                            <tr>
                                ...
                                <td>
                                    @if($effect->icon)
                                        <img src="{{ $effect->icon }}" alt="{{ $effect->title }}">
                                    @else
                                ...
                                <td>{{ $effect->slug }}</td>
                                <td>
                                    @if($effect->created_at)
                                        {{ $effect->created_at->format('d/m/Y') }}
                                    @else
                                        --
                                    @endif
                                </td>
                                ...
                                <td align="right">
                                    <a href="{{ route('dashboard.effect.edit', $effect->id) }}" class="btn btn-primary btn-sm">
