    ...
    <form action="{{ route('dashboard.post.create') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header py-3 bg-light">
                <h6 class="mb-0 fw-bold text-uppercase">Нова публікація</h6>
            </div>
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                ...
                <div class="form-check">
                    ...
                    <input class="form-check-input @error('nofollow') is-invalid @enderror" type="checkbox" name="nofollow" value="1" id="nofollow" @checked(old('nofollow'))>
                ...
                <div class="form-check">
                    ...
                    <input class="form-check-input @error('noindex') is-invalid @enderror" type="checkbox" name="noindex" value="1" id="noindex" @checked(old('noindex'))>
