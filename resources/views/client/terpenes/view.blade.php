...
@section('title', "$terpene->title | HEMPLY.CLUB - Інформаційний ресурс про коноплі українською")
@section('description', "Терпени та їх вплив | HEMPLY.CLUB - Актуальні новини та тренди конопляного світу. Інформаційний ресурс про коноплі українською")
    ...
    <header class="header-page">
        <div class="container">
            <div class="heading pt-4">
                <h1 class="fs-2 fw-bold text-white">{{ $terpene->title }}</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('terpene.page') }}" class="fw-bold">Терпени</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">{{ $terpene->title }}</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="heading pb-5">
                <div class="row">
                    <div class="col-6">
                        ...
                        <h2 class="title fw-bold mb-1">Сорти, що містять терпен</h2>
                    </div>
