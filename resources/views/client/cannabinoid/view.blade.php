...
@section('title', $cannabinoid->title . ' | HEMPLY.CLUB - Інформаційний ресурс про коноплі українською')
@section('description', 'Каннабіноїди та їх вплив | HEMPLY.CLUB - Інформаційний ресурс про коноплі українською')

@section('content')
    <header class="header-page">
        <div class="container">
            <div class="heading pt-4">
                <h1 class="fs-2 fw-bold text-white">{{ $cannabinoid->title }}</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('cannabinoid.page') }}" class="fw-bold">Канабіноїди</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">{{ $cannabinoid->title }}</li>
                    </ol>
                </nav>
            </div>
        </div>
